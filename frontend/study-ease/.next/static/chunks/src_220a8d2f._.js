...
async function login(email, password) {
    try {
        const response = await fetch("".concat(API_BASE_URL, "/api/login"), {
            method: 'POST',
            headers: {
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError("");
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(email, password);
...
_s(LoginPage, "Np8Rp3SaAiTWofEiX8buWU8LAKU=", false, function() {
    return [
